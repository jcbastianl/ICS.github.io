...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logoname.setBackground(new java.awt.Color(102, 102, 102));
        logoname.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        logoname.setForeground(new java.awt.Color(102, 102, 102));
        logoname.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        logoname.setText("Seguimiento deportivo");
        bg.add(logoname, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 90, -1, 50));

        citybg.setBackground(new java.awt.Color(0, 134, 190));
        citybg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/OIP.jpg"))); // NOI18N
        citybg.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        bg.add(citybg, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 160, 490, 240));
        ...
        bg.add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 840, 30));

        favicon.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        favicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Lg.jpg"))); // NOI18N
        favicon.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        bg.add(favicon, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 170, 80));

        title.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        title.setText("INICIAR SESIÓN");
        bg.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));
        ...
        bg.add(exitBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 10, 50, 40));
        ...
        bg.add(jLayeredPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 510, 450));
